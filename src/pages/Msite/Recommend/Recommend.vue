<template>
  <div class="rec_main">
    ...
    <div class="some_show">
      ...
      <div class="food_show">
        <ul class="food_wrap">
          <li class="food_item" v-for="(cate,index) in homeInfo.categoryHotSellModule.categoryList">
    ...
    <div class="crazyBuy"
      ...
      <div class="swiper-container goods_container">
        <div class="swiper-wrapper goods_wrapper">
          <div class="swiper-slide goods_slide" v-for="(goodItem) in catgItem.itemList">
